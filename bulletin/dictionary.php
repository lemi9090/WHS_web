                            ...
                            <table class="list-table">
                                ...
                                <tbody>
                                        ...
                                        if (isset($_GET['search_query']) && isset($_GET['search_type'])) {
                                            ...
                                            $sql = "SELECT id, subject, writer, create_date FROM free_bulletin WHERE board_id = 3 AND $field LIKE ? ORDER BY $order_by";
                                        ...
                                        if($search_active==false){
                                            if ($board_id == 3) {
                                                $sql = "SELECT id, subject, writer, create_date FROM free_bulletin WHERE board_id = 3 ORDER BY $order_by LIMIT 10";
